...
//también funciona con el método BRACKET NOTATION.
//if(objetoUsuario["password"] === password)
...
//como en el ejercicio anterior tambien funciona BRACKET NOTATION.
//en ambos casos se conoce el valor de la propiedad PASSWORD.
...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   //objetMuchosUsuarios: [{esPremium: "x"}, {esPremium: "x"}, {esPremium: "x"}, {esPremium: "x"},]
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   //objetoUsuario: {post:[{likes: 5}, {likes: 6}, {likes: 7}, {likes: 8]}
   var suma = 0
